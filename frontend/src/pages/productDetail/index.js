...
const ProductDetails =() =>{
    ...
    useEffect(() => {
        axios.get(`https://my-json-server.typicode.com/mauriciogregory/api/products${id}`).then((res) =>{
    ...
    return (
        <Container className="card">
            <Row className= "justify-content-between">
                ...
                <Button onclick={handlePutOnCart} className="button-cart" size="lg">Adicionar ao Carrindo</Button>
                </Col>
            </Row>
        </Container>
    );
